...
import { FontFamily, Border, Color, Gap, FontSize, Padding} from "../GlobalStyles";
  ...
  return (
    <View style={styles.home}>
      ...
      <View style={styles.groupParent}>
        ...
        <View style={[styles.frameWrapper, styles.homeInnerFlexBox]}>
      ...
      <View style={[styles.homeInner, styles.homeInnerFlexBox]}>
      ...
      <View style={styles.groupView}>
        ...
        <View style={styles.frameParent1}>
          ...
          <Pressable
            style={styles.groupParent1}
            onPress={() => navigation.navigate("GroceryDetails")}
          >
            <Image
              style={styles.frameChild1}
              contentFit="cover"
              source={require("../assets/group-36783.png")}
            />
            <Text style={[styles.fruits, styles.myFlatTypo]}>Groceries</Text>
          </Pressable>
          <View style={styles.groupParent1}>
            <Image
              style={styles.frameChild1}
              contentFit="cover"
              source={require("../assets/group-36784.png")}
            />
      ...
      <View style={[styles.groupParent6, styles.parentPosition]}>
        <Image
          ...
          contentFit="cover"
          source={require("../assets/group-36838.png")}
        />
        <Image
